...
Our killer feature is a built-in implementation of the Tor network protocol (also known as the darknet). We make all your network requests go through Tor, such that the people at the end of the pipe can't use your IP address to track you or censor you.
