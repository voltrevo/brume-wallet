...
export const ValidSeedPhraseRequired: Localized<string> = {
  en: "Please enter a valid seed phrase",
  zh: "请输入有效的种子短语",
  hi: "कृपया एक मान्य बीज वाक्य दर्ज करें",
  es: "Por favor, introduce una frase semilla válida",
  ar: "الرجاء إدخال عبارة بذور صالحة",
  fr: "Veuillez entrer une phrase de récupération valide",
  de: "Bitte geben Sie eine gültige Seed-Phrase ein",
  ru: "Пожалуйста, введите действительную фразу восстановления",
  pt: "Por favor, insira uma frase de semente válida",
  ja: "有効なシードフレーズを入力してください",
  pa: "ਕਿਰਪਾ ਕਰਕੇ ਇੱਕ ਵੈਧ ਬੀਜ ਵਾਕਾ ਦਿਓ",
  bn: "একটি বৈধ বীজ বাক্য লিখুন",
  id: "Silakan masukkan frase benih yang valid",
  ur: "براہ کرم ایک درست بیج جملہ درج کریں",
  ms: "Sila masukkan frasa benih yang sah",
  it: "Si prega di inserire una frase seed valida",
  tr: "Lütfen geçerli bir tohum cümlesi girin",
  ta: "ஒரு செல்லுபடியான விதை வாக்கை உள்ளிடவும்",
  te: "దయచేసి ఒక చెల్లని బీజ వాక్యాన్ని నమోదు చేయండి",
  ko: "유효한 시드 문구를 입력하십시오",
  vi: "Vui lòng nhập một cụm từ khóa hợp lệ",
  pl: "Proszę podać poprawną frazę seed",
  ro: "Vă rugăm să introduceți o frază seed validă",
  nl: "Voer een geldige seed-zin in",
  el: "Παρακαλώ εισάγετε μια έγκυρη φράση seed",
  th: "กรุณาใส่วลีเมล็ดที่ถูกต้อง",
  cs: "Zadejte prosím platnou frázi seed",
  hu: "Kérjük, adjon meg egy érvényes magmondatot",
  sv: "Ange en giltig fröfras",
  da: "Indtast venligst en gyldig seed-frase",
}