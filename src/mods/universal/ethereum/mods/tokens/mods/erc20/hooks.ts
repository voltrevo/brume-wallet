...
export function useERC20MetadataName(context: Nullable<EthereumContext>, contract: Nullable<ZeroHexString>, block: Nullable<BlockNumber>) {
...
export function useERC20MetadataSymbol(context: Nullable<EthereumContext>, contract: Nullable<ZeroHexString>, block: Nullable<BlockNumber>) {
  const storage = useUserStorageContext().getOrThrow()
...
export function useERC20MetadataDecimals(context: Nullable<EthereumContext>, contract: Nullable<ZeroHexString>, block: Nullable<BlockNumber>) {
  const storage = useUserStorageContext().getOrThrow()
