...
import { SimplePairDataV3, StoredPairData } from "@/libs/ethereum/mods/chain"
...
export function usePairV3Price(context: Nullable<FgEthereumContext>, pair: Nullable<SimplePairDataV3>, block: Nullable<string>) {
  const storage = useUserStorageContext().getOrThrow()
