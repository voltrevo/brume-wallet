import { AppRequest, BgAppRequest } from "@/mods/background/service_worker/entities/requests/data";
...
export namespace FgAppRequests {
  ...
  export function schema(storage: UserStorage) {
    return createQuery<string, AppRequest[], never>({ key: BgAppRequest.All.key, storage })
  }
