...
export namespace Priced {
  ...
  export namespace Native {
    ...
    export function schema(context: Nullable<EthereumContext>, account: Nullable<ZeroHexString>, currency: Nullable<"usd">, block: Nullable<string>, storage: QueryStorage) {
      if (context == null)
        return
      if (account == null)
        return
  ...
  export namespace Contract {
    ...
    export function schema(context: Nullable<EthereumContext>, contract: Nullable<ZeroHexString>, account: Nullable<ZeroHexString>, currency: Nullable<"usd">, block: Nullable<string>, storage: QueryStorage) {
      if (context == null)
        return
      if (contract == null)
        return
